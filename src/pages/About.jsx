  ...
  return (
    <>
      <section className="section page-section">
        <div className="container">
          ...
          <div className="about-grid reveal">
            ...
            <img src="/assets/images/slider_bg_1.jpg" alt="Oxford English School Building" className="reveal-right delay-1" />
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          <h2 className="section-title reveal">{t('features_section_title')}</h2>
